...
$(function (){
	$(".ba_leftf_block").click(function (){
			...
			var ba_three = "</div><div class='ba_rfb_close fr'><img src='/images/close.png'/></div></div>";
			...
			bal = bal.replace("/images/","");
			bal = bal.replace(".png","");
			if(bal == "circle010"){
				$(this).find(".ba_lfb_circle").find("img").attr("src","/images/circle011.png");
				...
				$(this).find(".ba_lfb_circle").find("img").attr("src","/images/circle010.png");
	...
	function addclose(){
		...
		$(".ba_leftf_box").find(".ba_lfb_circle").find("img").attr("src","/images/circle010.png");
