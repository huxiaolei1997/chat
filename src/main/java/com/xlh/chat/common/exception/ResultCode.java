 ...
 * @author 胡晓磊
 * @company xxx
 * @date 2020年04月19日 17:57 胡晓磊 Exp $
 */
public enum ResultCode {
    //    public static final int PERMISSION_TOKEN_EXPIRED_CODE = 10000;
//    public static final String PERMISSION_TOKEN_EXPIRED_MSG = "Token 过期";
//
//    public static final int PERMISSION_TOKEN_INVALID_CODE = 10001;
//    public static final String PERMISSION_TOKEN_INVALID_MSG = "Token解析异常";
//
//
//    public static final int PERMISSION_SIGNATURE_ERROR_CODE = 10002;
//    public static final String PERMISSION_SIGNATURE_ERROR_CODE_MSG = "签名异常";
//
//    public static final int USER_NOT_LOGGED_IN = 10003;
